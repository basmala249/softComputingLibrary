...
//         // Initialize population
//         for (int i = 0; i < geneticParams.getPopulationSize(); i++) {
//             Chromosome<Integer> newChromosome = new PermutationChromosome(
//                 geneticParams.getChromosomeLength(), fitnessFunction);
//             population.add(newChromosome);
//         }
      
//         SelectionInterface<Integer> selectionStrategy = new RouletteWheelSelection<>();
//         ICrossOver<Integer> crossoverStrategy = new OrderOneCrossOver<>();
//         IMutation<Integer> mutationStrategy = new InsertMutationStrategy<>();
//         IReplacement<Integer> replacementStrategy = new ElitismReplacement<>(2); 
...
//             // Select parents
//             List<Chromosome<Integer>> selectedChromosomes = selectionStrategy.select(
//                 population, geneticParams.getPopulationSize(), false);

//             // Generate offspring via crossover
//             List<Chromosome<Integer>> newOffsprings = new ArrayList<>();
//             for (int i = 0; i < selectedChromosomes.size(); i += 2) {
//                 double randomNum = getRandomNumber();
//                 System.out.println("Debug>> Crossover Random: " + randomNum + " < " + geneticParams.getCrossoverRate());
//                 if (randomNum < geneticParams.getCrossoverRate()) {
//                     List<Chromosome<Integer>> parents = new ArrayList<>();
//                     parents.add(selectedChromosomes.get(i));
//                     parents.add(selectedChromosomes.get(i + 1));
...
//                 } 
//                 else {
//                     // If no crossover, add parents directly
//                     newOffsprings.add(selectedChromosomes.get(i));
//                     newOffsprings.add(selectedChromosomes.get(i + 1));
//                 }
//             }
...
//                 if (randomNum < dynamicMutationRate) {
//                     newOffsprings.set(i, mutationStrategy.mutate(newOffsprings.get(i)));
//                     System.out.println("Debug>> Mutation Applied to Offspring " + i);
//                     System.out.print("Debug>> Mutated Offspring:: ");
